 ...
 * 1. 定义各个顶点的normal vector 和 光源向量
 * 2. normal vector向量先做插值，再在fragment shader里normalize到长度为1，再乘以光源向量得到余弦值，最后乘以颜色。
*/
...
export function render(canvas: HTMLCanvasElement) {
  ...
  function drawScene() {
    ...
    gl.uniform3fv(reverseLightDirectionLocatoin, new Float32Array([0.5, 0.7, 1]));
